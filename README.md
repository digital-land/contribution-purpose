# Developer Contribution Purpose pages
...
These pages are [updated nightly](https://github.com/digital-land/developer-contribution-purpose/actions) by the [GitHub Action](.github/workflows/run.yml).
